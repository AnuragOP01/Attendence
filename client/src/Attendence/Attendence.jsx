...
const handleSubmit = async () => {
  ...
  if (!anyStudentMarked) {
    ...
    const absentStudents = filteredStudents.filter((student, index) => markAbsent[index]);
    const presentStudents = filteredStudents.filter((student, index) => checkedStudents[index]);
